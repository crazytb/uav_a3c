...
\begin{equation}
    s = \{c_l, e_r, c_q, t_q, i_l, i_o, \mathbf{c}_m, \mathbf{t}_m, v, c\}
\end{equation}
and
\begin{equation}
    s' = \{c_l', e_r', c_q', t_q', i_l', i_o', \mathbf{c}_m', \mathbf{t}_m', v', c'\}
\end{equation}
where $\mathbf{c}_m, \mathbf{t}_m \in \mathbb{R}^K$ represent MEC queue state vectors.

The complete transition function can be decomposed into \textbf{endogenous} (action-dependent) and \textbf{exogenous} (action-independent) components:
\begin{equation}
