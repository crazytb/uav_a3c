...
\begin{split}
&P(o' | o, z, a) \\
&= P(c_l' | c_l, c_q, t_q, \mathbf{c}_m, \mathbf{t}_m, a) \\
&\times P(e_r' | e_r) \\
&\times P(c_q') \\
&\times P(t_q') \\
&\times P(i_l' | i_l, c_l, c_q, \mathbf{c}_m, a) \\
&\times P(i_o' | i_o, c_q, z, a) \\
&\times P(\mathbf{c}_m' | c_l, c_q, t_q, \mathbf{c}_m, \mathbf{t}_m, a) \\
&\times P(\mathbf{t}_m' | c_l, c_q, t_q, \mathbf{c}_m, \mathbf{t}_m, a),
\end{split}
\end{equation}
