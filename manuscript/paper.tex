...
\subsubsection{Endogenous State Transitions}

The endogenous components are directly influenced by the agent's actions and evolve according to system dynamics:
